                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="matricule" class="form-control {{ $errors->has('matricule') ? 'is-invalid' : '' }}"
                                        value="{{ $user->matricule }}" placeholder="Matricule"/>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" name="fonction" class="form-control {{ $errors->has('fonction') ? 'is-invalid' : '' }}"
                                        value="{{ $user->fonction }}" placeholder="Fonction"/>
                                @if($errors->has('fonction'))
                                <span class="help-block text-danger">
                                    <li>{{ $errors->first('fonction') }}</li>
                                </span>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="adresse" class="form-control {{ $errors->has('adresse') ? 'is-invalid' : '' }}"
