                    ...
                    <div class="auth-inner py-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('reset.password.post') }}" method="POST">
                                     @csrf
                                    ...
                                    <button class="btn btn-primary btn-block" type="submit" tabindex="4">Reinitialiser</button>
                                </form>
